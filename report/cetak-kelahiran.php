...
<body>
	...
	<center>
		...
		<h4>No Surat:
			<?php echo $data['id_pend']; ?>/Ket.Akte/<?php echo $tanggal; ?>
		</h4>
	</center>
	...
	<p style="text-indent: 25px;">Bahwa nama tersebut di atas benar warga saya yang bermaksud untuk <u>membuat Akte Kelahiran.</u><p>
