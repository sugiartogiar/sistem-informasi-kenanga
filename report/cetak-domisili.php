...
<body>
	...
	<center>
		...
		<h4>No Surat:
			<?php echo $data['id_pend']; ?>/Ket.Domisili/<?php echo $tanggal; ?>
		</h4>
	</center>
	...
	<p style="text-indent: 25px;">Bahwa nama tersebut di atas benar warga saya yang bermaksud untuk <u>membuat Surat Domisili.</u><p>
